...
\begin{frame}{\insertsubsection ~~第四类动词}
  ...
  \begin{tabular}{@{}llllll@{}} % 6 columns
    词根 & 过程 & 语干  \\
    \skttransroot{hṛṣ} & \reconstruction{hṛṣ-ya-} & \skttransverbstem{hṛṣya}  \\
  \end{tabular}
...
\begin{frame}{\insertsubsection ~~第六类动词}
  ...
  \begin{enumerate}
    \item
      ...
      \begin{tabular}{@{}llllll@{}} % 6 columns
        词根 & 过程 & 语干  \\
        \skttransroot{viś} & \reconstruction{viś-a-} & \skttransverbstem{viśa}  \\
      \end{tabular}
...
\begin{frame}{\insertsection  ~~\insertsubsection }
  ...
  \begin{tabular}{@{}lllll@{}} % 7 columns: type, length/type, and 5 vowels
    ...
    词尾的m & 开头元音 & m & \sktpada{kimatra} \fullpada{kim atra}  \\
