...
\begin{frame}{\insertsubsection~~动词的形态}
  \small
  \centering
  \begin{tabular}{@{}llllll@{}} % 6 columns
    词根 & 词干 & 词尾 & 词  \\
...
\subsection{朗读练习}
\begin{frame}{\insertsubsection~~第三章练习2}
  \small
  \centering
  \begin{verse}
    \skt{sarvadevatāḥ gandharvāḥ tridaśālayāḥ Rāmam} \\
    \mbox{\skt{kamalapattrāśram puṣpavarṣaiḥ ca vāgbhiḥ ca tuṣṭuvuḥ ।}} \\
    \mbox{\skt{Rāmam tathā pūjayitvā yathāgatam pratijagmuḥ ।}} \\
    \mbox{\skt{tat ākāśam mahotsavasaṃkāśam āsīt acyuta ।}} \\
    \skt{yadi sūryasahasrasya bhāḥ sadṛśī utthitā divi} \\
    \mbox{\skt{yugapat bhavet sā bhāsaḥ tasya mahātmanaḥ syāt ।}} \\
  \end{verse}
\end{frame}
