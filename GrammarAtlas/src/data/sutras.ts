...
export const sutras: Record<string, Sutra> = {
  ...
  "pan_3.1.124": {
    ...
    translation: "在以元音 ṛ 为末音的以及以辅音为末音的（词根）后，加 ṇyat。",
  ...
  "pan_1.1.26": {
    ...
    notes: "其后所遇是 ñ 和 ņ 符号时，以元音为末的词干发生三合的变化。",
    adhikaras: [], 
    references: [],
    parallel: ["dssk_162"],
    source: "panini"
   ...
   "dssk_162": {
    ...
    translation: "变化成为三合元音。（例如：）sakhāyau, sakhāyah; he sakhe; sakhāyam, sakhāyau, sakhīn, sakhyā, sakhye. ",
